...
/*
 * user-based with basic cosine similarity method
 * 
 */
public class UB_Cosine_0 extends UB_Algorithm implements Base {

    public UB_Cosine_0(int[][] train, int[][] test, List<Pair>[] rates, int b, int r, double cp, int k, double threshold) {
