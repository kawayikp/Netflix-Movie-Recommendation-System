 ...
 * choose K neighbors 
 * 
 * best when k = 200, threshold = 0.5
 */

public class UB_Cosine_best extends UB_Algorithm implements Base {
    public UB_Cosine_best(int[][] train, int[][] test, List<Pair>[] rates, int b, int r, double cp, int k, double threshold) {
