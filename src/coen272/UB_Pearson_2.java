 ...
 * if k = ? threshold = ?	-> hard to determine which parameter will improve performance
 * 							-> bad if k is small or threshold is large for Math.abs(similarity)
 */
public class UB_Pearson_2 extends UB_Algorithm {

    public UB_Pearson_2(int[][] train, int[][] test, List<Pair>[] rates, int b, int r, double cp, int k, double threshold) {
